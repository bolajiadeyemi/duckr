...
function usersDucks(state = initialUserDuckState, action) {
    switch (action.type) {
...
export default function userDucks(state = initialState, action) {
    switch (action.type) {
        case FETCHING_USER_DUCKS:
            return {
                ...state,
                isFetching: true
            }
        case FETCHING_USER_DUCKS_ERROR:
            return {
                ...state,
                isFetching: false,
                error: action.error
            }
        case FETCHING_USER_DUCKS_SUCCESS:
            return {
                ...state,
                isFetching: false,
                error: '',
...
function duckReplies(state =initialReply, action){
  switch(action.type){
    ...
    return {
      ...state,
      [acion.reply.replyId]: action.reply
    }
    case REMOVE_REPLY:
    return {
      ...state,
    ...
    switch (action.type) {
        ...
        case REMOVE_REPLY:
            return {
                ...
                isFetching: false,
                error: '',
                 [action.duckId]: repliesAndLastUpdated(state[acion.duckId], action)
            }
    }
}